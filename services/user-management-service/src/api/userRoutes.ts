...
import { createUser, getAllUsers, findUserById, updateUserStatus, updateUserRole, deleteUser, updateUserProfile, getUserActivity } from '../services/userService';
...
router.get('/', async (req: Request, res: Response) => {
  ...
  try {
    const users = await getAllUsers(status, role, q);
